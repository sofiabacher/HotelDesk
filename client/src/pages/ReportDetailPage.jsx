...
import { ArrowBack as ArrowBackIcon, Download as DownloadIcon, DateRange as DateRangeIcon, FilterList as FilterIcon, Assessment as AssessmentIcon, People as PeopleIcon, Event as EventIcon, Room as RoomIcon, Security as SecurityIcon } from '@mui/icons-material';
...
const ReportDetailPage = () => {
    ...
    const reportConfig = {
        ...
        'system': {
            ...
            subtitle: 'Métricas de rendimiento y salud del sistema',
            icon: AssessmentIcon,
            color: '#9c27b0',
    ...
    const handleGenerateReport = async () => {
        ...
        try {
            ...
            if (response.data.success && response.data.data) {
                ...
                const reportResult = response.data.data
                setReportData(reportResult.reportData || reportResult || [])
                showSnackbar('Reporte generado exitosamente', 'success')
